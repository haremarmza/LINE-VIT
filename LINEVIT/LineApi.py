...
class LINE:
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {'X-Line-Application': 'CHROMEOS\t8.0.1\tChrome_OS\t1', 'X-Line-Access': self.authToken, 'User-Agent': 'Line/8.0.1'}
    self.cert = self.Talk.cert
    self._headers = {
              'X-Line-Application': 'CHROMEOS\t8.0.1\tChrome_OS\t1', 
