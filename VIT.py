...
#----------------------------------------------------------------------------
            ...
            elif msg.text in ["Myginfoid","#ไอดีกลุ่ม"]:
...
#""")
            ...
            elif msg.text in ["Auto like:on","เปิด ไลค์","Like on"]:
                if wait["likeOn"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done。")
                else:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already。")
            elif msg.text in ["Like off","ปิด ไลค์","Auto like:off"]:
...
#-----------------------------------------------
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"ปฏิเสธกลุ่มเชิญเรียบร้อยแล้ว👌")
                else:
