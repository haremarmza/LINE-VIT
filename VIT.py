...
║☬Tag1:  ➡ใส่ข้อความตอบกลับ 1
║☬Tag2:  ➡ใส่ข้อความตอบกลับ 2
╚═════════════════════
╔═════════════════════
...
║☬Tag1 ➡เช็คข้อความตอบแทค 1
║☬Tag2 ➡เช็คข้อความตอบแทค 2
╚═════════════════════
──┅═✥===========✥═┅──
╔═════════════════════
║[By.☬ധู้さန້ণق↔ധഖาໄฟ☬]
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                if wait["detectMention"] == True:
                    ...
                    balas = [cName + "\n" + str(wait["tag1"]) , cName + "\n" + str(wait["tag2"])]
                    ret_ = "[ตอบกลับ อัตโนม้ติ]" + random.choice(balas)
