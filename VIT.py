...
❂͜͡☆➣ 『/พูด』  คิกเกอพูดตาม
❂͜͡☆➣ 『ลบรัน』
❂͜͡☆➣ 『คิก1 -- คิก10  ลบรัน』 ลบรันคิกเกอร์
❂͜͡☆➣ 『ประกาศ:』
❂͜͡☆➣ 『ผู้สร้าง』
❂͜͡☆➣ 『ผู้สร้างกลุ่ม』
❂͜͡☆➣ 『ทีมงาน』
...
#""")
            ...
            elif msg.text in ["เปิด ไลค์","Auto like:on","Like on"]:
                if wait["likeOn"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done。")
                else:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already。")
            elif msg.text in ["ปิด ไลค์","Like off","Auto like:off"]:
...
#-----------------------------------------------
            ...
            elif msg.text in ["Reject","คิก2 ลบรัน"]:
            ...
            elif msg.text in ["Reject","คิก3 ลบรัน"]:
            ...
            elif msg.text in ["Reject","คิก4 ลบรัน"]:
            ...
            elif msg.text in ["Reject","คิก5 ลบรัน"]:
            ...
            elif msg.text in ["Reject","คิก6 ลบรัน"]:
            ...
            elif msg.text in ["Reject","คิก7 ลบรัน"]:
            ...
            elif msg.text in ["Reject","คิก8 ลบรัน"]:
            ...
            elif msg.text in ["Reject","คิก9 ลบรัน"]:
            ...
            elif msg.text in ["Reject","คิก10 ลบรัน"]:
