...
❂͜͡☆➣ 『Mid @』
❂͜͡☆➣ 『Cn: 』  ตั้งชื่อ
❂͜͡☆➣ 『ตั้งชื่อ: 』ตั้งชื่อ นาฬิกา
❂͜͡☆➣ 『เปิด นาฬิกา』
❂͜͡☆➣ 『ปิด นาฬิกา』
❂͜͡☆➣ 『กลุ่ม』
❂͜͡☆➣ 『Tl: text』
❂͜͡☆➣ 『Tx:』 สร้างชื่อไวรัส
❂͜͡☆➣ 『เปิด ดึงกลับ』
❂͜͡☆➣ 『ปิด ดึงกลับ』
❂͜͡☆➣ 『เปิด เข้ากลุ่ม』
❂͜͡☆➣ 『ปิด เข้ากลุ่ม』
...
❂͜͡☆➣ 『คิกมา』
❂͜͡☆➣ 『คิกออก』
❂͜͡☆➣ 『คิก1 -- คิก10』  เรียกคิกทีล่ะตัว
❂͜͡☆➣ 『€€€』   คำสั่งบิน
❂͜͡☆➣ 『Kill』
❂͜͡☆➣ 『เทส』
❂͜͡☆➣ 『ยกเชิญ』
...
#===========================================
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["😈ขอบคณณน๊า ที่แทคหา😈\n😆ว่าแต่ ที่แท็คมานี้ 😆\nจะแจกติก ใหห้ ใช่ป่ะ😆\n🙋nแจกเร็วๆน๊า เรารออยู่🙋 \nอิอิอิ"]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                cl.sendMessage(msg)
            elif msg.text.lower() == 'hack bo","บอท':
                msg.contentType = 13
...
#----------------------------------------------------------------------------
            ...
            elif "Gc","ผู้สร้างกลุ่ม" == msg.text:
                try:
                    group = cl.getGroup(msg.to)
...
#==================================================
            ...
            elif "#ประกาศ:","ประกาศ:" in msg.text:
...
#========================================
                ...
                if wait["protectionOn"] == True  md+="􀬁􀆐ป้องกัน  : ✔ 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 ป้องกัน : ❌ 􀜁􀄰􏿿\n"
...
#-----------------------------------------------
                ...
                if wait["Backup"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Sudah on Bos\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Backup:off","Backup off"","ปิด ดีกลับ","ปิดการเชิญกลับ"]:
...
#========================================
#-------------------Fungsi spam finish----------------------------
            elif "รูปกลุ่ม","Hackginfo" in msg.text:
              if msg.from_ in admin:
					group = cl.getGroup(msg.to)
...
#                                    ki2.sendText(msg,to,"
            elif msg.text.lower() == 'รีบอท","#rebootbotall':
                if msg.toType == 2:
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                ...
                try:
                   ...
                   for target in targets:
                       try:
                           ...
                           cl.sendText(msg.to,"Error")
            elif "สั่งดำ @","Blacklist @" in msg.text:
...
#==============================================================================#
            ...
            elif msg.text in ["Friendlist","เช็คเพื่อนทั้งหมด","#เพื่อย","เพื่อนทั้งหมด","Fyall"]:    
            ...
            elif "แทค","Tagall" == msg.text.lower():
                 group = cl.getGroup(msg.to)
...
#==============================================================================#
                ...
                try:
                    ...
                    pass
            elif "#picall","#ดึงรูป" in msg.text:
