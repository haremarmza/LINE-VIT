       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"เช็คกันจัง กลัวบอทหลุด ล่ะสิ😆😆")
        ...
        if op.type == 17:
            if wait["Notifed"] == True:
                ...
                image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                cl.sendText(op.param1,cl.getContact(op.param2).displayName + " ☜ʕ•ﻌ•ʔ "+ http://dl.profile.line-cdn.net/" + contact.pictureStatus")
