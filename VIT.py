...
wait = {
    ...
    "lang":"JP",
    "comment":"Auto Like [By.☬ധู้さန້ণق↔ധഖาໄฟ☬]\nhttp://line.me/ti/p/9r-uE5EU09",
    "commentOn":True,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":True,
		...
		for posts in cl.activity(1)["result"]["posts"]:
			if wait["posts"] == True:
				if posts["postInfo"]["liked"] is False:
					...
					ki1.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1002)
					ki1.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],c_text)
					ki2.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1002)
					ki2.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],c_text)
					ki3.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1002)
					ki3.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],c_text)
					ki4.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1002)
					ki4.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],c_text)
				     ki5.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1002)
					ki5.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],c_text)
					ki6.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1002)
					ki6.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],c_text)
					ki7.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1002)
					ki7.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],c_text)
					ki8.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1002)
					ki8.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],c_text)
					ki9.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1002)
					ki9.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],c_text)
				     ki10.like(posts["userInfo"]["writerMid"], posts["postInfo"]["postId"], 1002)
					ki10.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],c_text)
					print u"liked" + str(i)
					i += 1
    except Exception as e:
            print e
