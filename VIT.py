...
#========================================
                ...
                if wait["commentOn"] == True: md+="􀬁􀆐􏿿 Comment : ✔ 􀜁􀄯􏿿\n"
...
#-------------------------------------------------
                ...
                cl.sendText(msg.to, "ผู้สร้าง 1 SELFBOT By.🔯ധู้さန້ণق↔ധഖาໄฟ🔯")
                msg.contentMetadata = {'mid': 'uf0bd4970771f26a8cef66473d59bcc69'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ผู้จัดการ .SELFBOT By.☬ധู้さန້ণق↔ധഖาໄฟ☬")
                msg.contentMetadata = {'mid': 'u6c8aab6ee167a596be2cf045ee2f90df'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "🔯ҨՁণゆԳন By.ധู้さန້ণق↔ധഖาໄฟ🔯")
                ...
                msg.contentMetadata = {'mid': 'u5b671f4148aa5bbec186b5b7cb295271'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ตัวแทนสมาชิก By.•┅͜͡❍(🌫️ℤ⃢ɧび)‮•┅͜͡❍ ")
                msg.contentMetadata = {'mid': 'u34673bd6e9ba56020037155572e2d379'}
                cl.sendMessage(msg)
